...
class UIScene_DebugEnhanced : public UIScene
{
private:
	static LPCWSTR m_CheatCheckboxText[25];

	int m_iTotalCheckboxElements;

public:
	UIScene_DebugEnhanced(int iPad, void *initData, UILayer *parentLayer);

	virtual EUIScene getSceneType() { return eUIScene_DebugEnhanced;}

protected:
	UIControl_CheckBox m_checkboxes[25];
	UI_BEGIN_MAP_ELEMENTS_AND_NAMES(UIScene)
		...
		UI_MAP_ELEMENT( m_checkboxes[21], "checkbox22")
		UI_MAP_ELEMENT( m_checkboxes[22], "checkbox23")
		UI_MAP_ELEMENT( m_checkboxes[23], "checkbox24")
		UI_MAP_ELEMENT( m_checkboxes[24], "checkbox25")
